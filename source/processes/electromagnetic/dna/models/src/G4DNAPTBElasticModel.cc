                                      ...
                                      const G4DataVector& /*cuts*/, G4ParticleChangeForGamma*)
{
    ...
    if(particle == electronDef)
    {
        ...
        AddCrossSectionData("C3H8",
                            particleName,
                            "dna/sigma_elastic_e-_PTB_C3H8",
                            "dna/sigmadiff_cumulated_elastic_e-_PTB_C3H8",
                            scaleFactor);
...
{  
    ...
    if (particleDefinition == G4Electron::ElectronDefinition())
    {
        ...
        //        At some point I encountered a segmentation fault here, when primary electron energy was 1 MeV.
